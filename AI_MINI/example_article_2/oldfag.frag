...
<div class="stripe">
	<div class="content">
		...
		<div class="section">
			...
			<img src="example_article_2/me3.png" class="blockImg clickable" onClick="openLightbox('example_article_2/me3.png')"/>
		</div>
		<h4>Section 2</h4>
		<div class="section">
			<p>
			...
			<img src="example_article_2/reaction.png" class="blockImg clickable" onClick="openLightbox('example_article_2/reaction.png')"/>
		</div>
		<div class="section">
			<div class="code">
				Some code for no reason<br/>
				Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus sagittis lectus at ipsum efficitur sagittis. Suspendisse non augue condimentum, placerat dolor in, pellentesque lacus. Aenean malesuada leo ac ante feugiat, at suscipit nisi mattis. Quisque sagittis eu lectus ut sodales. Sed eu nisi nisi. Proin ex augue, tincidunt sit amet nunc et, consectetur feugiat ligula. Vivamus mi est, malesuada vel pellentesque id, blandit convallis mauris.
			</div>
		</div>
		<h4>Section 3</h4>
		<div class="section">
			...
			<img src="example_article_2/trash.png" class="blockImg clickable" onClick="openLightbox('example_article_2/trash.png')"/>
		</div>
	</div>
</div>
<div class="stripe">
